---
layout: post
title: Week 11 – Cathedral, Bazaar, and My Growing Confidence in OSS
---
...
This discussion also made me reflect on my own experience this semester. The more I contribute, the more I realize that open source is not only about writing code faster, but about building shared understanding through discussion, review, and iteration.
...
More importantly, it helped me see that confidence in open source does not come from knowing everything, but from being willing to start small, ask questions, and keep iterating.